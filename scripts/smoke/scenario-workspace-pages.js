        ...
        await waitForCondition(
          ...
          `
            (() => {
              ...
              return headers === '순번|지정정렬|모집시기|전형명|전형코드|계열명|계열코드|모집단위명|모집단위코드|전공명|전공코드|시험날짜|시작시간|종료시간|교시명|교시코드|고사건물명|고사건물코드|고사실명|고사실코드|수험번호|가번호|이름|생년월일|조|OPT1|OPT2|OPT3|OPT4|OPT5|OPT6|OPT7|OPT8|OPT9|OPT10';
            })()
          `,
