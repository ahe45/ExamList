...
CREATE TABLE IF NOT EXISTS candidate_records (
  ...
  source_id VARCHAR(255) NOT NULL DEFAULT '' COMMENT '원본 시스템의 데이터 식별자',
  designated_sort VARCHAR(120) NOT NULL DEFAULT '' COMMENT '지정정렬',
  admission_year VARCHAR(20) NOT NULL DEFAULT '' COMMENT '학년도',
  exam_date VARCHAR(120) NULL COMMENT '시험일',
  ...
  birth_date VARCHAR(120) NULL COMMENT '수험생 생년월일',
  ...
  opt6 VARCHAR(255) NOT NULL DEFAULT '' COMMENT '사용자 옵션 6',
  opt7 VARCHAR(255) NOT NULL DEFAULT '' COMMENT '사용자 옵션 7',
  opt8 VARCHAR(255) NOT NULL DEFAULT '' COMMENT '사용자 옵션 8',
  opt9 VARCHAR(255) NOT NULL DEFAULT '' COMMENT '사용자 옵션 9',
  opt10 VARCHAR(255) NOT NULL DEFAULT '' COMMENT '사용자 옵션 10',
  ...
  UNIQUE KEY uniq_candidate_records_school_examinee_period (school_id, examinee_no, period_code),
...
CREATE TABLE IF NOT EXISTS school_settings (
  ...
  campus_name VARCHAR(120) NOT NULL DEFAULT '' COMMENT '캠퍼스명',
  campus_code VARCHAR(120) NOT NULL DEFAULT '' COMMENT '캠퍼스 코드',
  academic_year VARCHAR(20) NOT NULL DEFAULT '' COMMENT '학년도',
