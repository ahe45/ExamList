...
export const dataDeletionItems = Object.freeze([
  Object.freeze({
    description: "양식은 유지하고 현재 학교의 운영 데이터를 모두 정리합니다.",
    impact: "수험생, 사진, 생성 PDF, 작업 로그를 모두 삭제합니다. 현재 학교와 양식 및 편집 스냅샷은 유지됩니다.",
    scope: "all",
    summary: Object.freeze(["수험생 정보 및 사진", "PDF 생성 결과/파일/작업 로그"]),
    title: "전체 데이터",
  }),
  Object.freeze({
