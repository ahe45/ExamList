...
function createRouteDeps(appContext) {
  ...
  return Object.freeze({
    ...
    previewCandidatePhotoArchiveStream: (...args) => services.candidateRecordService.previewCandidatePhotoArchiveStream(...args),
    getCandidateGridOptions: (...args) => services.candidateRecordService.findCandidateGridOptions(...args),
    exportCandidateRows: (...args) => services.candidateRecordService.exportCandidateRows(...args),
    ...
    hasPermission,
    getOperation: (id, request) => services.operationService.get(id, getRequestAccountId(request)),
    submitOperation: (request, metadata, task) => services.operationService.submit({ ...metadata, ownerId: getRequestAccountId(request) }, task),
    getRequestAccountId,
